...
describe('test.set-operations.js', () => {
  ...
  it('should work with $and 1', async () => {
    const db = context.db;
  ...
  it('should work with $and 2, same index', async () => {
    const db = context.db;
    await db.createIndex({
      "index": {
        "fields": ["series", "debut"]
  ...
  it('should work with $and 3, index/no-index', async () => {
    const db = context.db;
    await db.createIndex({
      "index": {
        "fields": ["series"]
