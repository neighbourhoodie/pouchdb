...
export default class Changes extends EventEmitter {
  ...
  addListener(dbName, id, db, opts) {
    ...
    function eventFunction() {
      ...
      const eee = db.changes(changesOpts).on('change', function (c) {
      ...
      // const oldEmit = eee.emit
      // eee.emit = function(event, data) {
      //   oldEmit.call(eee, event)
      // }      
    }
