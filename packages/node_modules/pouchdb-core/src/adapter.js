...
class AbstractPouchDB extends EventEmitter {
    ...
    this.getAttachment = adapterFun('getAttachment', function (docId, attachmentId, opts, callback) {
      ...
      this._get(docId, opts, (err, res) => {
        ...
        if (res.doc._attachments && res.doc._attachments[attachmentId]) {
          ...
          console.log('pouchdb core adapter getAttachment', 'getting attachment', docId, attachmentId, opts)
  ...
  changes(opts, callback) {
    console.trace('abstract pouchdb changes called', opts, callback)
    if (typeof opts === 'function') {
      callback = opts;
      opts = {};
    }
    ...
    console.log('about to ch')
    const ch = new Changes(this, opts, callback);
    return ch
  }
