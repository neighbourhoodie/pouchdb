...
AbstractPouchDB.prototype.registerDependentDatabase =
  adapterFun('registerDependentDatabase', function (dependentDb,
                                                          callback) {
  let dbOptions = this.__opts;
  // not sure if this works
  if (this.__opts.view_adapter) {
    dbOptions = this.__opts.view_adapter;
  }

  var depDB = new this.constructor(dependentDb, dbOptions);
  console.log('*** *** dependentDb', dependentDb);
  console.log('*** *** this.__opts', this.__opts);
